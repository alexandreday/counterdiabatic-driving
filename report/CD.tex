...
In \cite{abanin2017recent}, form of $\tau_i$ is given as 
\begin{equation}
...
\caption{Protocol chosen for going from $\lambda_i=0$ to $\lambda_f=-10$ in time $\tau$}
\end{figure}
...
\caption{Fidelity and final energy above ground state for L=12 spin chains}
\end{figure}
