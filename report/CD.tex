...
\end{align*}
where $G(z)= \sum_{n=0}^{\infty} C^{(2n+1)} z^{2n+1}$ is the generating function.
...
\beta(z) &= z/(1 -\alpha^2  z^2 ) \simeq -\dfrac{1}{\alpha^2 z} \\
 ...
 \omega_1 &= \delta_3 +  \delta_1     \beta(z) \simeq \delta_3 \\  
 \theta_0&= c_0 +  \epsilon_1  z \beta(z) a_1 \simeq c_0 -\dfrac{\epsilon_1   a_1}{\alpha^2}    \\
 \theta_1&= \epsilon_2 + \epsilon_1   \beta(z) \simeq \epsilon_2
\end{align*}
...
&\simeq \dfrac{\alpha^2}{(\delta_1 -  \alpha^2 \delta_2) z^2      }
\end{align*}
...
& \simeq \dfrac{1}{1 - \epsilon_3 z^2 + \epsilon_1  z^2/ \alpha^2 -\epsilon_2   \delta_3 z^6 \tau(z)     }\\
& \simeq -\dfrac{\delta_1/ \alpha^2 - \delta_2}{\epsilon_2   \delta_3     } \dfrac{1}{z^4}\\
& \simeq -\dfrac{\delta_1 - \delta_2  \alpha^2}{\epsilon_2   \delta_3    \alpha^2   } \dfrac{1}{z^4}
\end{align*}


Hence, we get for $C(z)$:
\begin{align*}
C(z)  &=  \eta(z) \theta_0+  \omega_0 \theta_1  z^3 \eta(z) \tau(z)   \\
& \simeq -\dfrac{\delta_1 - \delta_2  \alpha^2}{\epsilon_2   \delta_3    \alpha^2   } \left(c_0 -\dfrac{\epsilon_1   a_1}{\alpha^2} \right) \dfrac{1}{z^4} +  \omega_0 \theta_1  z^3 \eta(z) \tau(z) \\
&\simeq -\dfrac{\delta_1 - \delta_2  \alpha^2}{\epsilon_2   \delta_3    \alpha^2   } \left(c_0 -\dfrac{\epsilon_1   a_1}{\alpha^2} \right) \dfrac{1}{z^4} - \epsilon_2 \left(b_0 - \dfrac{ \delta_1  a_1}{\alpha^2}  \right)  \left( \dfrac{\delta_1 - \delta_2  \alpha^2}{\epsilon_2   \delta_3    \alpha^2   }  \right) \left(\dfrac{\alpha^2}{\delta_1 -  \alpha^2 \delta_2    } \right) \dfrac{1}{z^3}
\end{align*}


Hence, we get for $B(z)$:
\begin{align*}
B(z)  & = \omega_0 \tau(z) +    \omega_1 z^3  \tau(z) \eta(z) \theta_0 + \omega_0 \omega_1  \theta_1    z^2 \eta(z)  \tau(z) ^2   \\
& = \left(\dfrac{b_0 \alpha^2 -  \delta_1  a_1}{\delta_1 -  \alpha^2 \delta_2}\right)\dfrac{1}{ z^2      }+    \omega_1 z^3  \tau(z) \eta(z) \theta_0 + \omega_0 \omega_1  \theta_1    z^2 \eta(z)  \tau(z) ^2 \\
& = \left(\dfrac{b_0 \alpha^2 -  \delta_1  a_1}{\delta_1 -  \alpha^2 \delta_2}\right)\dfrac{1}{ z^2      }- z^3   \delta_3 (c_0 -\dfrac{\epsilon_1   a_1}{\alpha^2}   )  (\dfrac{\alpha^2}{(\delta_1 -  \alpha^2 \delta_2) z^2      }) (\dfrac{\delta_1 - \delta_2  \alpha^2}{\epsilon_2   \delta_3    \alpha^2   } \dfrac{1}{z^4})  + \omega_0 \omega_1  \theta_1    z^2 \eta(z)  \tau(z) ^2 \\
& = \left(\dfrac{b_0 \alpha^2 -  \delta_1  a_1}{\delta_1 -  \alpha^2 \delta_2}\right)\dfrac{1}{ z^2      }-  \left(\dfrac{c_0 \alpha^2-\epsilon_1   a_1}{\delta_1 -  \alpha^2 \delta_2     } \dfrac{\delta_1 - \delta_2  \alpha^2}{\epsilon_2       \alpha^2   }\right)  \dfrac{1}{z^3} + \omega_0 \omega_1  \theta_1    z^2 \eta(z)  \tau(z) ^2 \\
& = \left(\dfrac{b_0 \alpha^2 -  \delta_1  a_1}{\delta_1 -  \alpha^2 \delta_2}\right)\dfrac{1}{ z^2      }-  \left(\dfrac{c_0 \alpha^2-\epsilon_1   a_1}{\delta_1 -  \alpha^2 \delta_2     } \dfrac{\delta_1 - \delta_2  \alpha^2}{\epsilon_2       \alpha^2   }\right)  \dfrac{1}{z^3} - z^2 (b_0 - \dfrac{ \delta_1  a_1}{\alpha^2})\delta_3  \epsilon_2    (\dfrac{\delta_1 - \delta_2  \alpha^2}{\epsilon_2   \delta_3    \alpha^2   } \dfrac{1}{z^4})  \left(\dfrac{\alpha^2}{(\delta_1 -  \alpha^2 \delta_2) z^2      } \right)^2 \\
& = \left(\dfrac{b_0 \alpha^2 -  \delta_1  a_1}{\delta_1 -  \alpha^2 \delta_2}\right)\dfrac{1}{ z^2      }-  \left(\dfrac{c_0 \alpha^2-\epsilon_1   a_1}{\delta_1 -  \alpha^2 \delta_2     } \dfrac{\delta_1 - \delta_2  \alpha^2}{\epsilon_2       \alpha^2   }\right)  \dfrac{1}{z^3} -   \dfrac{(b_0 \alpha^2 - \delta_1  a_1)   (\delta_1 - \delta_2  \alpha^2 ) }{(\delta_1 -  \alpha^2 \delta_2)   ^2  } \dfrac{1}{z^6}
\end{align*}
...
& \simeq -\dfrac{1}{\alpha^2 z} (a_1  + \left(\dfrac{b_0 \alpha^2 -  \delta_1  a_1}{\delta_1 -  \alpha^2 \delta_2}\right) + z^2 C(z)) \\
& \simeq -\dfrac{1}{\alpha^2 z} (a_1  + \left(\dfrac{b_0 \alpha^2 -  \delta_1  a_1}{\delta_1 -  \alpha^2 \delta_2}\right)) \\
\end{align*}
...
&=  \dfrac{-\hbar}{\mu} \dfrac{i \mu}{\alpha^2 } \left(a_1  + \dfrac{b_0 \alpha^2 -  \delta_1  a_1}{\delta_1 -  \alpha^2 \delta_2}\right)\\
&=  \dfrac{-i \hbar}{\alpha^2 } \left(a_1  + \dfrac{b_0 \alpha^2 -  \delta_1  a_1}{\delta_1 -  \alpha^2 \delta_2}\right) 
\end{align*}
%
