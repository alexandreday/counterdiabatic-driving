...
\subsubsection{Variational solution of adiabatic gauge potential}

\begin{equation}
G_{\lambda}= \partial_{\lambda} H + \dfrac{i}{\hbar} [\chi, H] 
\end{equation}
If $\chi= A_{\lambda}$, then $[H,G_{\lambda}]=0 $
...
G_{\lambda}= \partial_{\lambda} H + \dfrac{i}{\hbar} [\chi, H] 
\end{equation}
If $\chi= A_{\lambda}$, then $[H,G_{\lambda}]=0 $. Let's reformulate it in a way that's easier to compute. 
\begin{align}
