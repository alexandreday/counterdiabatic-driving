...
**blah blah ...numerically we can see four different regimes in which we can understand three of them** 
...
\caption{Two different scaling regimes of $1/\mu$ and $1/\mu^4$: $y_1=\frac{\alpha_1}{x^{\beta_1}}$ and $y_2=\frac{\alpha_2}{x^{\beta_2}}$ where $\beta_1=1.02$, $\beta_2=3.88$, $\alpha_1=0.682$ and $\alpha_2=328.38$ which are found using least square method}
\end{center}
\end{figure}

Analytically, we can talk about three regimes:
\begin{itemize}
