 ...
 f_O(\bar{E}, \omega)=\left\{
  \begin{array}{@{}ll@{}}
    e^{-\omega T} & (\omega \gg T), \\
     \dfrac{L}{\omega^2+ \mu_T^2} & (\omega \ll T)
  \end{array}\right.
\end{equation}
...
\caption{Integrable systems: exact gauge potential as a function of system size. Periodic boundary conditions shows linear scaling in system size. }
\end{center}
\end{figure}
