...
\begin{figure}[!ht]
\begin{center}
\includegraphics[scale=0.7]{new_pics/norm_L_scaling.eps}
\caption{exact gauge potential as a function of system size}
\label{mu_scaling}
\end{center}
\end{figure}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[scale=0.7]{new_pics/max_wij.eps} \\
\includegraphics[scale=0.7]{new_pics/min_wij.eps}\\
\caption{Using ED method, $\min \omega_{ij}(L)$ and $\max \omega_{ij}(L)$}
\label{mu_scaling}
\end{center}
\end{figure}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[scale=0.7]{new_pics/v2_slope.eps}
