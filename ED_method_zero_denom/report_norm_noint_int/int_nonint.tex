...
\end{align}
 \begin{equation}
 \boxed{[H, G_{\lambda}(\mu)]= \dfrac{i}{\hbar} \mu^2 A_{\lambda} (\mu)}
 \end{equation}
...
Let's truncate the series by arguing that we have no control over boundary. We do this by putting restriction on $\mu$ that it goes to $\infty$ when $n=L$. 
